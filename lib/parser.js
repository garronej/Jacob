...
*/
    ...
    Parser.prototype.parse = function (lexer, context) {
        ...
        //Define a method on the stack to easily get an element
        
        this.stack = Object.create(Array.prototype, {
                "getItem": {
                        "value": function(index){
                                return this[this.length+index].i;
                        }
                }
        });
        ...
        //Giving access to the stack from context

        if( !this.context.hasOwnProperty("__stack__") ){
            Object.defineProperty( this.context, "__stack__", { "value": this.stack });
        }
